...
// Adauga sau nu campului pt. upload imagine
...
?></div><br/>
  ...
  <input type="submit" value="<?php echo $lsite['msgs']['addmsg']; ?>" id="addcomm" /><br/><span id="marplo">&copy; <a href="http://coursesweb.net/php-mysql/register-login-script-users-online_s2" title="Users script">coursesweb.net</a></span>
  </form>
</div>