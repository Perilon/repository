...
class UsersReg extends Users {
  ...
  private function getReg($ar_post) {
    ...
    $pass = $ar_post['pass'];
    $email = strtolower($ar_post['email']);
    $re = false;
  ...
  private function setFormReg() {
    ...
    if(isset($_SESSION['nregistered'])) $re = $_SESSION['registered'];
      ...
      '<form action="" method="post" id="reg_form">
       <label style="margin: 0 0 0 0;" for="email">E-Mail: </label><input type="text" name="email" maxlength="55" id="email" value="'.$email.'" />
       <label style="margin: 0 0 0 0;" for="username">'.$this->lsite['users_logform']['name'].'</label><input type="text" name="username" maxlength="32" id="username" value="'.$username.'" />
       <label style="margin: 0 0 0 0;" for="pass">'.$this->lsite['users_logform']['pass'].'</label><input type="password" name="pass" maxlength="18" id="pass" value="'.$pass.'" />
       <label style="margin: 0 0 0 0;" for="pass2">'.$this->lsite['register']['pass2'].'</label><input type="password" name="pass2" maxlength="18" id="pass2" value="'.$pass2.'" />
       <label style="margin: 0 0 0 0;" for="codev">'.$this->lsite['codev'].'</label><input type="text" name="codev" size="5" maxlength="6" id="codev" />
       <input style="margin: 0 0 0 0;" type="submit" name="susr" value="'.$this->lsite['users_logform']['register'].'" />
      </form></div>';
      }
    return $re;
  }
