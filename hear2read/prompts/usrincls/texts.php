...
<i>Thanks, respectfully,<br/> Admin</i><br/>",
    ...
    'regtxt'=>'<h3>Registration</h3><div id="form_re" style="margin: auto;">
      <p style="font-size: .75em; text-align: center; margin: 0 0 0 0;"><b> - For Security Add this verification code below: <span  id="codev0">%s</span></b></p><p style="margin:0 0 0 0;">Fill out all entries below.</P><hr style="width:88px;" /><br/>',
  ...
  <p>Add the e-mail address you used for registration and this verification code: <span id="codev0">%s</span></p><br/>',
    ...
    'reconfirm'=>'<center><h2 style="color:blue;">Confirmation approved</h2><h4>Now you can log on the site. <a href="app.php">Home Page</a></h4></center>',
