...
// The users table
$sqlc['users'] = "CREATE TABLE `users` (`name` VARCHAR(32), `id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, `passenc` VARCHAR(32), `email` VARCHAR(55), `rank` DECIMAL(1,0) DEFAULT 0, `ip_reg` VARCHAR(15), `ip_visit` VARCHAR(15), `dtreg` INT(11) NOT NULL, `dtvisit` INT(11) NOT NULL, `visits` SMALLINT UNSIGNED DEFAULT 0, `pass` VARCHAR(25), `language` VARCHAR(25)) CHARACTER SET utf8 COLLATE utf8_general_ci";
...
// table for languates
$sqlc['languages'] = "CREATE TABLE `languages` (`id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, `language` VARCHAR(25), `prompt_dir` VARCHAR(48)) CHARACTER SET utf8 COLLATE utf8_general_ci";

// table for user projects
$sqlc['projects'] = "CREATE TABLE `projects` (`id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, `uid` INT, `startpoint` VARCHAR(8), `endpoint` VARCHAR(8), `complete` INT) CHARACTER SET utf8 COLLATE utf8_general_ci";
