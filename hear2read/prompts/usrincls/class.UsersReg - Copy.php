  ...
  private function setFormReg() {
    ...
    if(isset($_SESSION['nregistered'])) $re = $_SESSION['registered'];
      ...
      '<form action="" method="post" id="reg_form">
       <label for="email">E-Mail: </label><input type="text" name="email" maxlength="55" id="email" value="'.$email.'" />
       <label for="username">'.$this->lsite['users_logform']['name'].'</label><input type="text" name="username" maxlength="32" id="username" value="'.$username.'" />
       <label for="pass">'.$this->lsite['users_logform']['pass'].'</label><input type="password" name="pass" maxlength="18" id="pass" value="'.$pass.'" />
       <label for="pass2">'.$this->lsite['register']['pass2'].'</label><input type="password" name="pass2" maxlength="18" id="pass2" value="'.$pass2.'" />
       <label for="codev">'.$this->lsite['codev'].'</label><input type="text" name="codev" size="5" maxlength="6" id="codev" />
