...
define('RANK', 0);
define('ACCOUNT', 0);       // If the value is different from 1, allow to create multiple accounts with same IP

define('ALLOWIMG', 0);                             // allows upload images in message (1), not allow (0)
define('ALLOWMAIL', 0);                            // allows mail notification when new message (1), not allow (0)
