...
?>
	<head>
		<title>Hear2Read Synthesis Demo</title>
	...
	<body class="homepage">
		...
		<div id="header-wrapper">
				<div id="header" class="container">
				    <div class="row">
					    <div class="4u important(collapse)">
							<!-- Logo -->
					...
					<!-- Nav -->
							<nav id="nav">
								<ul>
									...
									<li><a class="icon fa-cog" href="app.php"<span>Demo</span></a></l1>
							...
							<div>
								<h1 style="margin-bottom:0;">Indic Text To Speech Demo</h1>
								<p style='margin:0 0 0 0;'><span style='font-weight:900'>Listen to speech generated by the Flite Text-To-Speech software.</span>
<!--									<br />A version of this code runs on Android devices available from Google Play store.  -->
								</p>
							</div>
						</div>
				    </div>
